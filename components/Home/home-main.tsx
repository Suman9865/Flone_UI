  ...
  return (
    <div className="md:min-h-screen w-full py-10 relative">
      ...
      <div className="flex flex-col justify-start items-start md:w-2/3 w-full md:pl-20 pl-3 ">
        ...
        Duis dapibus rutrum urna, sit amet accumsan velit efficitur sed. 
        Phasellus blandit lacinia consequat. Integer auctor, mi id mollis fringilla, magna elit dignissim ex, ac vulputate odio justo sed purus.
        </p>
      </div>
    </div>
  );
